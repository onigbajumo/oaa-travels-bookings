    ...
    <>
        ...
        <div className="container py-20">
          <div className="space-y-6 flex flex-col justify-center">
            <div className="space-y-8 ">
              <h1 className="text-main">Terms & Privacy Policies</h1>
              <p className="xl:pr-48 lg:pr-12">
                Explore the terms governing your use of our services and our
                commitment to protecting your privacy, ensuring transparency,
                and building a relationship of trust with you.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="container py-20 flex justify-center">
        <div className="max-w-4xl space-y-10">
          <h2 className="text-main">Terms of Service</h2>
          <div>
            ...
            <div className="pl-4 space-y-4">
              ...
              <p>
                {" "}
                You must not use our website to distribute any material which is
          ...
          <div>
            ...
            <div className="pl-4 space-y-4">
              <p>
                ...
                the property of Ehizuahub or its content suppliers and protected
          ...
          <div>
            ...
            <div className="pl-4 space-y-4">
              <p>
                Ehizua Hub will not be liable for any damages arising from the
                use of, or inability to use, our website or any information
                contained on it.
              </p>
              <p>
                {" "}
          ...
          <div>
            ...
            <div className="pl-4 space-y-4">
              <p>
                ...
                with the laws of [Your Country/State], and any disputes relating
                to these terms will be subject to the exclusive jurisdiction of
                the courts of Nigeria.
              </p>
            </div>
          </div>

          <h2 className="text-main">Privacy Policy</h2>
          <div>
            <h1 className="font-semibold text-lg">1. Introduction</h1>
            <div className="pl-4 space-y-4">
              <p>
                Ehizua Hub is committed to protecting your privacy. This Privacy
          ...
          <div>
            ...
            <div className="pl-4 space-y-4">
              ...
              <p>
                ...
                information about you whenever you interact with our website.
                This may include your browser name, the type of computer, and
          ...
          <div>
            ...
            <div className="pl-4 space-y-4">
              <p>
                To personalize your experience and respond to your individual
                needs.
              </p>
              <p>
          ...
          <div>
            ...
            <div className="pl-4 space-y-4">
              <p>
                ...
                safety of your personal information. Your information is stored
                in secure networks and is only accessible by a limited number of
          ...
          <div>
            ...
            <div className="pl-4 space-y-4">
              <p>
                ...
                your personally identifiable information except to provide
