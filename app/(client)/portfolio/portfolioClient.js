      ...
      <section className="container space-y-5 py-20">
        <div className="grid md:grid-cols-2 gap-7">
          {filteredProjects.map((project, index) => (
            <div className="bg-[#F4F7F8] rounded-lg flex flex-col" key={index}>
              <div>
                <Image
                  src={project.image}
                  alt={project.title}
              ...
              <div className="p-2 md:p-4 bg-[#F4F7F8] rounded-br-lg rounded-bl-lg h-full justify-between flex flex-col">
                <div>
